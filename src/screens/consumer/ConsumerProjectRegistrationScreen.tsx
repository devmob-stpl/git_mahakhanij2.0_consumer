...
import type { GeoPoint, ProjectCategory } from '@/domain';
...
export function ConsumerProjectRegistrationScreen() {
  ...
  function handleQuickFill() {
    ...
    setTalukaCode('PUN-HVL');
    setTalukaName('Haveli');
    setVillageCode('PUN-HVL-WGH');
    setVillageName('Wagholi');
    setLine1('Gat No. 88/2, Paud Road, Wagholi');
    setPincode('412115');
    setSiteGeo({ latitude: 18.5793, longitude: 73.9781 });
    setErrors({});
  }
