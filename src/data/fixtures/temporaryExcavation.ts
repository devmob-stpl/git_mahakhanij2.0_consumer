...
export const temporaryExcavationApplications: TemporaryExcavationApplication[] = [
  ...
  {
    id: 'tea-004',
    applicationNumber: 'TEA/2026/001420',
    organizationId: 'org-001',
    applicant,
    projectId: 'proj-002',
    packageId: 'pkg-004',
    ...
    declarationAcceptedAt: daysAgo(5),
    statusUpdatedAt: daysAgo(5),
    documents: [
      { id: 'doc-004a', fileName: 'site-plan-kharadi.pdf', kind: 'SITE_PLAN', documentType: 'Site plan', uploadedAt: daysAgo(5) },
    ],
  },
  {
    id: 'tea-007',
    applicationNumber: 'TEA/2026/001488',
    organizationId: 'org-001',
    applicant,
    projectId: 'proj-001',
    packageId: 'pkg-002',
    mineralId: 'min-murum',
    estimatedQuantity: q(550),
    excavationMethod: 'MECHANISED',
    applicationFee: { amount: 1000, currency: 'INR' },
    purpose: 'Drainage channel embankment formation.',
    siteAddress: {
      line1: 'Survey No. 132/4, Asangaon',
      taluka: 'Shahapur',
      district: 'Thane',
      state: 'Maharashtra',
      pincode: '421601',
    },
    siteGeo: { latitude: 19.4312, longitude: 73.3105 },
    village: 'Asangaon',
    surveyNumber: '132/4',
    landType: 'PRIVATE',
    areaInSqm: 2200,
    depthInMetres: 2,
    fromDate: dateDaysAhead(12),
    toDate: dateDaysAhead(72),
    status: 'UNDER_REVIEW',
    submittedAt: daysAgo(3),
    declarationAcceptedAt: daysAgo(3),
    statusUpdatedAt: daysAgo(3),
    documents: [
      { id: 'doc-007a', fileName: 'site-plan-asangaon.pdf', kind: 'SITE_PLAN', documentType: 'Site plan', uploadedAt: daysAgo(3) },
    ],
  },
  ...
  },
  {
    ...
    packageId: 'pkg-003',
    mineralId: 'min-stone',
    estimatedQuantity: q(1500),
    excavationMethod: 'MECHANISED',
    applicationFee: { amount: 1000, currency: 'INR' },
    purpose: 'Crushed stone aggregate for viaduct foundation piers.',
    siteAddress: {
      line1: 'Survey No. 142/A, Talegaon Dabhade',
      taluka: 'Maval',
      district: 'Pune',
      state: 'Maharashtra',
      pincode: '410506',
    },
    siteGeo: { latitude: 18.7291, longitude: 73.6842 },
    village: 'Talegaon Dabhade',
    surveyNumber: '142/A',
    landType: 'GOVERNMENT',
    areaInSqm: 5200,
    depthInMetres: 4,
    fromDate: dateDaysAgo(15),
    toDate: dateDaysAhead(75),
    status: 'ORDER_ISSUED',
    submittedAt: daysAgo(30),
    declarationAcceptedAt: daysAgo(30),
    statusUpdatedAt: daysAgo(10),
    demandNote: {
      demandNoteNumber: 'DN/2026/003912',
      issuedAt: daysAgo(18),
      dueDate: dateDaysAgo(4),
      totalAmount: { amount: 336_000, currency: 'INR' },
      breakdown: [
        { label: 'Royalty', amount: { amount: 300_000, currency: 'INR' } },
        { label: 'District Mineral Foundation', amount: { amount: 30_000, currency: 'INR' } },
        { label: 'District cess', amount: { amount: 6_000, currency: 'INR' } },
      ],
    },
    excavationOrder: {
      orderNumber: 'EXO/2026/000755',
      issuedAt: daysAgo(10),
      validFrom: dateDaysAgo(15),
      validUntil: dateDaysAhead(75),
      permittedQuantity: q(1500),
    },
    documents: [
      { id: 'doc-008', fileName: 'site-demarcation.pdf', kind: 'SITE_PLAN', documentType: 'Site plan', uploadedAt: daysAgo(30) },
      { id: 'doc-009', fileName: 'excavation-permit-order.pdf', kind: 'OTHER', documentType: 'Excavation order', uploadedAt: daysAgo(10) },
    ],
  },
  {
    id: 'tea-008',
    applicationNumber: 'TEA/2026/001509',
    organizationId: 'org-001',
    applicant,
    projectId: 'proj-001',
    packageId: 'pkg-001',
    mineralId: 'min-murum',
    estimatedQuantity: q(800),
    excavationMethod: 'MECHANISED',
    applicationFee: { amount: 1000, currency: 'INR' },
    purpose: 'Embankment widening near river drainage canal.',
    siteAddress: {
      line1: 'Survey No. 45/2, Vashind',
      taluka: 'Shahapur',
      district: 'Thane',
      state: 'Maharashtra',
      pincode: '421604',
    },
    siteGeo: { latitude: 19.4521, longitude: 73.3452 },
    village: 'Vashind',
    surveyNumber: '45/2',
    landType: 'PRIVATE',
    areaInSqm: 3200,
    depthInMetres: 3,
    fromDate: dateDaysAhead(15),
    toDate: dateDaysAhead(75),
    status: 'REJECTED',
    submittedAt: daysAgo(14),
    declarationAcceptedAt: daysAgo(14),
    statusUpdatedAt: daysAgo(4),
    statusRemarks: 'Proposed excavation site falls within 100m restricted river buffer zone. Tahsildar environmental NOC rejected.',
    documents: [
      { id: 'doc-010', fileName: 'site-plan-vashind-45.pdf', kind: 'SITE_PLAN', documentType: 'Site plan', uploadedAt: daysAgo(14) },
      { id: 'doc-011', fileName: 'rejection-order-notice.pdf', kind: 'OTHER', documentType: 'Rejection notice', uploadedAt: daysAgo(4) },
    ],
  },
];
