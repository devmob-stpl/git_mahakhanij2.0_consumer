...
export const en = {
  ...
  organizationHome: {
    ...
    findStockPoint: 'Find mineral place',
  ...
  /** Mineral acquisition: Find Mineral Place → Details → Enquiry. */
  discovery: {
    title: 'Find mineral place',
    searchPlaceholder: 'Mineral place, taluka or district',
    filters: 'Filters',
    listView: 'List',
    mapView: 'Map',
    mineral: 'Mineral',
    ...
    apply: 'Apply',
    clearAll: 'Clear all',
    resultCount: (count: number) => `${count} ${count === 1 ? 'mineral place' : 'mineral places'}`,
    noResults: 'No mineral places match',
    noResultsBody: 'Try widening the distance or clearing a filter.',
    noDestination: 'Select a package first',
    noDestinationBody:
      'Mineral places are ranked by distance from your site, so choose the package you are sourcing for.',
  ...
  enquiry: {
    ...
    remarks: 'Remarks',
    remarksPlaceholder: 'Anything the mineral place should know',
    submit: 'Send enquiry',
    submitting: 'Sending…',
    sentTitle: 'Enquiry sent',
    sentBody: 'The mineral place has your requirement. You can follow it here.',
    viewEnquiry: 'View enquiry',
    noEnquiries: 'No enquiries yet',
    noEnquiriesBody: 'Find a mineral place and send your first mineral enquiry.',
    findStockPoint: 'Find mineral place',
  ...
  consumerHome: {
    ...
    needMineralBody: 'Find a mineral place near you and send an enquiry.',
    mineralAvailability: 'Mineral availability',
    nearestSource: 'Nearest source',
    notAvailable: 'Not available',
    viewStockPoints: 'View mineral places',
  ...
  /** Materials Sourcing & Stock Ledger. */
  inventory: {
    title: 'Materials & Stock Ledger',
    received: 'Total Sourced',
    consumed: 'Utilized',
    transferred: 'Transferred',
    available: 'Active on Site',
    thisPackage: 'This package',
    allPackages: 'All packages',
    noStock: 'No minerals sourced yet',
    noStockBody: 'Minerals delivered under valid e-TP passes will appear here in your compliance ledger.',
    ...
    balanceTitle: 'Material Ledger',
    lastUpdated: 'Last updated',
    recordConsumption: 'Record consumption',
    transferStock: 'Transfer surplus',
    markAsUtilized: 'Mark as Fully Utilized',
    reactivateStock: 'Reactivate Material',
    statusActive: 'Active on Site',
    statusUtilized: 'Utilized in Work',
    sourcingPassesTitle: 'Legal Sourcing Passes (e-TP)',
    sourcingPassesHint: 'Verified electronic transit permits proving legal procurement and royalty payment.',
    history: 'Procurement & Movement Audit',
    transferHistory: 'Surplus Transfer Passes (e-TP)',
    noHistory: 'No movement recorded yet',
    noHistoryBody: 'Procured deliveries and transit passes will be listed here.',
    fullyConsumed: 'Batch marked fully utilized in construction',
    allCategories: 'All Minerals',
  },
  ...
  transfer: {
    sheetTitle: 'Transfer surplus mineral',
    sheetBody:
      'Generate a verified Transfer e-TP to legally move mineral to another site, package, or return to a mineral place.',
    destinationType: 'Transfer destination',
    destinationPackage: 'Another Project / Package',
    destinationConsumerSite: 'Another Personal Site',
    destinationStockPoint: 'Return to Mineral Place',
    destinationExternal: 'External Site',
    selectPackage: 'Select destination package',
    selectStockPoint: 'Select mineral place',
    siteAddressLabel: 'Destination address',
    ...
    submitAction: 'Issue Transfer e-TP',
    submitting: 'Generating permit…',
    issuedTitle: 'Transfer e-TP issued',
    issuedBody: 'Your electronic transit pass is generated. The vehicle may now transit lawfully.',
    screenTitle: 'Outgoing Transfer & Dispatch',
    permitTitle: 'Transfer Transit Pass (e-TP)',
    driverHandoverTitle: 'Driver Handover & Gate Pass',
    driverHandoverSubtitle: 'Share the digital transit permit with the driver before dispatching.',
    shareWhatsApp: 'Share on WhatsApp',
    sendSms: 'Send via SMS',
    viewDriverPass: 'View / Print Gate Pass',
    confirmDispatch: 'Confirm Vehicle Departure',
    confirmDispatching: 'Marking departed…',
    dispatchedBanner: 'Vehicle is currently in transit with driver',
    deliveredBanner: 'Delivery completed and verified at destination site',
    timelineTitle: 'Transfer & Movement Timeline',
    timelinePermitIssued: 'Transfer e-TP Generated',
    timelineDispatched: 'Vehicle Dispatched from Origin',
    timelineInTransit: 'In Transit on Highway',
    timelineReceiving: 'Destination Arrival & Verification',
    timelineReceivingHint: 'Destination site will scan and receive upon truck arrival.',
    officialHeader: 'GOVERNMENT OF MAHARASHTRA • REVENUE & MINING DEPT',
    subHeader: 'Electronic Minor Mineral Transit Permit (e-Transfer Pass)',
    etpNumber: 'e-TP Number',
    validityWindow: 'Transit Permit Validity',
    origin: 'Origin site',
    destination: 'Destination site',
    vehicle: 'Vehicle details',
    driver: 'Driver details',
    mineral: 'Mineral & Quantity',
    qrCodeTitle: 'Driver Electronic Gate Pass',
    qrCodeHint: 'The driver shows this QR code to highway mining flying squads and at destination offloading.',
    historyTitle: 'Transfers & Transit Passes',
    noTransfers: 'No transfer permits',
    noTransfersBody: 'Transfer permits generated for surplus minerals will appear here.',
    allTransfersTitle: 'Mineral Transfers',
  },
  ...
  auth: {
    ...
    gstNumberLabel: 'GSTIN / GST Number',
    gstNumberPlaceholder: '15-character GSTIN (e.g. 27AAAAA0000A1Z5)',
    gstNumberHint: '15-digit Goods and Services Tax Identification Number',
    gstNumberInvalid: 'Enter a valid 15-character GSTIN (e.g. 27AAAAA0000A1Z5).',
    gstNumberRequired: 'Enter your organization GSTIN.',
    verifyGst: 'Verify',
    verifyingGst: 'Verifying…',
    gstVerified: 'GSTIN Verified (Active)',
    gstVerifiedDetails: 'Entity verified with Maharashtra State GST Portal',
    registrationNumberLabel: 'Mahakhanij registration number (optional)',

    deliveryTitle: 'Where should mineral be delivered?',
    deliveryHelp: 'Used to find nearby mineral places and to verify deliveries on arrival.',
